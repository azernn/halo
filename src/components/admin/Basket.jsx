            ...
            <div className='flex justify-between gap-4 flex-col lg:flex-row'>
                <div className='border-t border-b border-gray-300 w-full lg:w-[75%] h-fit py-6'>
                    <div className='flex justify-between px-6'>
                        ...
                        <div className='flex flex-col justify-between items-center'>
                            <p className='text-[#e60] font-semibold hidden md:block'>555,9DKK</p>
                ...
                <div className='lg:w-[25%] w-full sm:w-[50%] '>
                    ...
                    <div className='border rounded-xl border-gray-300 mt-4 py-3 md:w-full w-1/2'> 
                        ...
                        <div className='flex flex-wrap p-4 gap-3 w-full'>
                            <img  className='w-[26%]' src="https://www.newlinehalo.dk/on/demandware.static/-/Sites/default/dwde3bf532/Visa.PNG" alt="" />
                            <img  className='w-[26%]' src="https://www.newlinehalo.dk/on/demandware.static/-/Sites/default/dw61d27b03/Visa%20electron.PNG" alt="" />
                            <img  className='w-[26%]' src="https://www.newlinehalo.dk/on/demandware.static/-/Sites/default/dwb2070354/mc_symbol_opt_73_3x.png" alt="" />
                            <img  className='w-[26%]' src="https://www.newlinehalo.dk/on/demandware.static/-/Sites/default/dwa3e4abe9/maestro.png" alt="" />
                            <img  className='w-[26%]' src="https://www.newlinehalo.dk/on/demandware.static/-/Sites/default/dw06a580d4/DK_Logo(2).png" alt="" />
                            <img  className='w-[26%]' src="https://www.newlinehalo.dk/on/demandware.static/-/Sites/default/dwb5dedb30/images/payment-methods/Mobile%20Pay.svg" alt="" />
                        </div>
                    </div>
                </div>
